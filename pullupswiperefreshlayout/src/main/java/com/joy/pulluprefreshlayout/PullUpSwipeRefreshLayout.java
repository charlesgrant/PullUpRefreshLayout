package com.joy.pulluprefreshlayout;
                ...
                synchronized (PullUpSwipeRefreshLayout.this) {
                    if (mListView != null) {
                        ...
                        if (isLoading()) {
                            ...
                            pull_to_refresh_load_more_text.setText(R.string.refresh_loading);
                        } else {
                            pull_to_refresh_load_progress.setVisibility(View.GONE);
                            pull_to_refresh_load_more_text.setText(R.string.refresh_load_more);
                            mYDown = 0;
                            mLastY = 0;
                        }
                    }
